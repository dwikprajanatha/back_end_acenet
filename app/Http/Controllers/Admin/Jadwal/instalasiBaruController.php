...
class instalasiBaruController extends Controller
{
    public function index(Request $request)
    {
        ...
        $listSPK = DB::table('tb_spk')->join('tb_customer', 'tb_spk.id_customer', '=', 'tb_customer.id')
            ...
            ->where('tb_spk.status', 0)->where('jenis_pekerjaan', 1)
        ...
        $data = [
            ...
            'header_title' => 'List SPK Instalasi Baru',
            'lists' => $listSPK,
        ];

        return view('admin.jadwal.instalasi.list_jadwal')->with($data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            'title' => 'Instalasi Baru',
            'header_title' => 'Buat SPK Instalasi Baru',
            'customers' => $listCustomer,
            'teknisi' => $listTeknisi,
            'no_spk' => $formatted_no_spk,
        ];

        return view('admin.jadwal.instalasi.buat_jadwal')->with($data);
    }
    ...
    public function detail(Request $request)
    {
        ...
        $data = [
            'title' => 'Instalasi Baru',
            'header_title' => 'Detail SPK Instalasi Baru',
            'spk' => $detailSPK,
            'teknisi' => $ikr,
        ];

        return view('admin.jadwal.instalasi.detail_jadwal')->with($data);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $data = [
            'title' => 'Instalasi Baru',
            'header_title' => 'Edit SPK Instalasi Baru',
            'spk' => $detailSPK,
            'ikr' => $arr_ikr,
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('instalasiBaru')->with('success', 'SPK Berhasil diupdate!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function batal(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('instalasiBaru')->with('success', 'SPK berhasil dibatalkan!');
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
            dd($e);
